...
void PlainTextBox::_001OnDraw(netnodedsView * pview, CDC * pgraphics)
{
...
void PlainTextBox::_001OnLButtonDown(netnodedsView * pview, gen::message::sender_object * pobj)
{
...
void PlainTextBox::_001OnLButtonUp(netnodedsView * pview, gen::message::sender_object * pobj)
{
	SCAST_PTR(igui::win::message::mouse, pmouse, pobj);
	CDC * pgraphics = pview->GetDC();
...
void PlainTextBox::_001OnCalcLayoutProc(netnodedsView * pview, CDC * pgraphics)
{
   if(m_pfont != NULL)
	{
		pgraphics->SelectObject(m_pfont);
...
void PlainTextBox::_001OnCalcLayout(netnodedsView * pview, CDC * pgraphics)
{
if(m_pfont != NULL)
	{
		pgraphics->SelectObject(m_pfont);
...
int PlainTextBox::char_hit_test(netnodedsView * pview, CDC * pgraphics, int px, int py)
{
   if(m_pfont != NULL)
	{
		pgraphics->SelectObject(m_pfont);
...
void PlainTextBox::_001OnMouseMove(netnodedsView * pview, gen::message::sender_object * pobj)
{
	SCAST_PTR(igui::win::message::mouse, pmouse, pobj);
...
void PlainTextBox::_001OnChar(netnodedsView * pview, gen::message::sender_object * pobj)
{
...
void PlainTextBox::_001OnSysChar(netnodedsView * pview, gen::message::sender_object * pobj)
{
   SCAST_PTR(igui::win::message::key, pkey, pobj);
